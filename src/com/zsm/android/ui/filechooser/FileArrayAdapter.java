package com.zsm.android.ui.filechooser;
...
public class FileArrayAdapter extends ArrayAdapter<File> {
	...
	private int mResource; //Represents the list_rowl file (our rows)
						// as an int e.g. R.layout.list_row
	...
	/*Does exactly what it looks like. Pulls out a specific File Object
	 *  at a specified index. Remember that our FileArrayAdapter contains
	 *   a list of Files it gets from our model's getAllFiles(), so getitem(0)
	 *   is the first file in that List, getItem(1), the second, etc.
	 *   ListView uses this method internally.*/
	@Override
	...
	/**
	 *  Allows me to pull out specific views from the row xml file for the
	 *  ListView. I can then make any modifications I want to the ImageView
	 *  and TextViews inside it. 
	...
	@Override public View getView(int position, View convertView, ViewGroup parent) {
		/*This is the entire file [list_rowl] with its RelativeLayout, ImageView,
		 * and two TextViews. It will always be null the very first time, so we
		 * need to inflate it with a LayoutInflater.*/
		View v = convertView;
		if (v == null) {
